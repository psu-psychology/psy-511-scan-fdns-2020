...
```{r, fig.cap='http://www.nature.com/nrn/journal/v7/n1/images/nrn1824-f3.jpg'}
knitr::include_graphics("http://www.nature.com/nrn/journal/v7/n1/images/nrn1824-f3.jpg")
```
...
```{r}
knitr::include_graphics("http://www.nature.com/nrendo/journal/v9/n10/images/nrendo.2013.136-f2.jpg")
```
