...
```{r, fig.cap="https://www.nimh.nih.gov/health/statistics/major-depression.shtml"}
knitr::include_graphics("img/samsa-depression-2017.png")
```

```{r, fig.cap="https://www.nimh.nih.gov/health/statistics/major-depression.shtml"}
knitr::include_graphics("img/samsa-depression-2017-teens.png")
```

## Genetic risk

```{r, fig.cap="[[@Sullivan2000-no]](http://dx.doi.org/10.1176/appi.ajp.157.10.1552)"}
knitr::include_graphics("https://ajp.psychiatryonline.org/cms/10.1176/appi.ajp.157.10.1552/asset/images/medium/q42f1.jpeg")
```
...
```{r, fig.cap="[[@Pawluski2017-dy]](http://dx.doi.org/10.1016/j.tins.2016.11.009)"}
knitr::include_graphics("https://ars.els-cdn.com/content/image/1-s2.0-S0166223616301771-gr1.jpg")
```
