...
```{r, fig.cap='[[@Bullmore2009-mx]](Bullmore2009-mx)'}
knitr::include_graphics("img/bullmore-spoorns-2009-box-1.png")
```
...
```{r, fig.cap='[[@Bullmore2009-mx]](Bullmore2009-mx)'}
knitr::include_graphics("img/bullmore-spoorns-2009-box-2.png")
```
...
```{r, fig.cap='[[@Bullmore2009-mx]](Bullmore2009-mx)'}
knitr::include_graphics("https://media.springernature.com/full/springer-static/image/art%3A10.1038%2Fnrn2575/MediaObjects/41583_2009_Article_BFnrn2575_Fig1_HTML.jpg?as=webp")
```
...
```{r, fig.cap='[[@Bullmore2009-mx]](Bullmore2009-mx)'}
knitr::include_graphics("https://media.springernature.com/full/springer-static/image/art%3A10.1038%2Fnrn2575/MediaObjects/41583_2009_Article_BFnrn2575_Fig2_HTML.jpg?as=webp")
```
...
```{r, fig.cap='[[@Bullmore2009-mx]](Bullmore2009-mx)'}
knitr::include_graphics("https://media.springernature.com/full/springer-static/image/art%3A10.1038%2Fnrn2575/MediaObjects/41583_2009_Article_BFnrn2575_Fig3_HTML.jpg?as=webp")
```
...
```{r, fig.cap='[[@Raichle2015-fg]](http://dx.doi.org/10.1146/annurev-neuro-071013-014030)'}
knitr::include_graphics("img/raichle-2015-fig-1.png")
```
...
```{r, fig.cap='[[@Raichle2015-fg]](http://dx.doi.org/10.1146/annurev-neuro-071013-014030)'}
knitr::include_graphics("img/raichle-2015-fig-2.png")
```
...
```{r, fig.cap='https://thecounter.org/wp-content/uploads/2019/08/blue-crab-meat-mislabeling-chesapeake-bay-country-of-origin-label-seafood-fraud-august-2019.jpg'}
knitr::include_graphics("https://thecounter.org/wp-content/uploads/2019/08/blue-crab-meat-mislabeling-chesapeake-bay-country-of-origin-label-seafood-fraud-august-2019.jpg")
```

Figure 1

```{r, fig.cap='[[@Bargmann2012-yg]](Bargmann2012-yg)'}
knitr::include_graphics("https://onlinelibrary.wiley.com/cms/asset/4484398d-7b52-431d-8688-330309466443/mfig001.jpg")
```
...
```{r, fig.cap='https://en.wikipedia.org/wiki/Caenorhabditis_elegans'}
knitr::include_graphics("https://upload.wikimedia.org/wikipedia/commons/thumb/c/cc/Adult_Caenorhabditis_elegans.jpg/2880px-Adult_Caenorhabditis_elegans.jpg")
```
...
```{r, fig.cap='[[@Bargmann2012-yg]](Bargmann2012-yg)'}
knitr::include_graphics("https://onlinelibrary.wiley.com/cms/asset/2b168248-c939-4507-8899-e20b4b172e4b/mfig002.jpg")
```
...
```{r, fig.cap='https://en.wikipedia.org/wiki/Drosophila_melanogaster'}
knitr::include_graphics("https://upload.wikimedia.org/wikipedia/commons/thumb/9/95/Drosophila_melanogaster_Proboscis.jpg/440px-Drosophila_melanogaster_Proboscis.jpg")
```

Figure 3

```{r, fig.cap='[[@Bargmann2012-yg]](Bargmann2012-yg)'}
knitr::include_graphics("https://onlinelibrary.wiley.com/cms/asset/8aa0b2a3-fa49-4c44-9476-ce54e1c13d1b/mfig003.jpg")
```
...
```{r, fig.cap='[[@Yan2017-od]](http://dx.doi.org/10.1038/nature24056)'}
knitr::include_graphics("https://media.springernature.com/full/springer-static/image/art%3A10.1038%2Fnature24056/MediaObjects/41586_2017_Article_BFnature24056_Fig1_HTML.jpg?as=webp")
```
