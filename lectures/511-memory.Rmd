...
```{r, fig.cap="https://www.pbs.org/wgbh/nova/media/images/corkin-hm-memory-08.width-800.jpg"}
knitr::include_graphics("http://www-tc.pbs.org/wgbh/nova/assets/img/corkin-hm-memory/image-08-large.jpg")
# HM's brain
```
